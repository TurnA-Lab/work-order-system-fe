...
export default {
  ...
  methods: {
    handleClick(e, row) {
      // transform-vue-jsx 的 nativeOnClick 失效 , 所以采用 event.cancelBubble 控制点击事件的冒泡... 如果点击事件不影响你的点击行事件，可以不传
    ...
    fetchTableData() {
      ...
      axios
        .post(
          "https://www.easy-mock.com/mock/5b3f80edfa972016b39fefbf/example/tableData",
          {
